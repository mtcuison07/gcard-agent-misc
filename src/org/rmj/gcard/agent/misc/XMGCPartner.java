...
import org.rmj.gcard.base.misc.GCPartner;
 ...
 * @author kalyptus
 */
public class XMGCPartner implements XMRecord {

   private XMTownCity poTownx = null;

   public XMGCPartner(GRider foGRider, String fsBranchCd, boolean fbWithParent){
      this.poGRider = foGRider;
      if(foGRider != null){
         this.pbWithParnt = fbWithParent;
         this.psBranchCd = fsBranchCd;
         poCtrl = new GCPartner();
    ...
    public void setMaster(int fnCol, Object foData) {
      if(pnEditMode != EditMode.UNKNOWN && poCtrl != null){
        // Don't allow update for sPartnrID, cRecdStat, sModified, and dModified
        if(!(fnCol == poData.getColumn("sPartnrID") ||
...
//         poCmpny = null;
   ...
   private UnitGCardPartner poData;
   private GCPartner poCtrl;
